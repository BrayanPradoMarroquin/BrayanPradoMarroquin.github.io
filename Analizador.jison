...
;
//--------------------------------------------------------------- MAIN ------------------------------------------------------------
MainBody: TK_VOID TK_MAIN PARENTESIS_ABRE PARENTESIS_CIERRA LlaveAbre Instructions LlaveCierra { $$ = Instruccion.nuevoStart("main", [], $6, this._$.first_line, this._$.first_column+1) }
...
For: TK_FOR PARENTESIS_ABRE Dec_Var Expresiones TK_PYC Actualizacion PARENTESIS_CIERRA LlaveAbre Instructions LlaveCierra { $9.push($6); $$ = new Instruccion.nuevoFor($3, $4, $9, this._$.first_line,this._$.first_column+1) }
	| TK_FOR PARENTESIS_ABRE Dec_Var Expresiones TK_PYC Actualizacion PARENTESIS_CIERRA LlaveAbre LlaveCierra { $$ = new Instruccion.nuevoFor($3, $4, [$6], this._$.first_line,this._$.first_column+1) }
        | TK_FOR IDENTIFICADOR IN Expresiones LlaveAbre Instructions LlaveCierra {$$ = new Instruccion.nuevoFor($2, $4, $6, this._$.first_line,this._$.first_column+1)} 
...
operString: Expresiones CONCATENADOCADENA Expresiones {$$= Instruccion.nuevaOperacionBinaria($1,$3, TIPO_OPERACION.SUMA,this._$.first_line,this._$.first_column+1); }
        | operString CONCATENADOCADENA Expresiones {$$= Instruccion.nuevaOperacionBinaria($1,$3, TIPO_OPERACION.SUMA,this._$.first_line,this._$.first_column+1); }
        | CADENA OP_EXPONENTE ENTERO {$$= Instruccion.nuevaOperacionBinaria(Instruccion.nuevoValor($1, TIPO_VALOR.CADENA, this._$.first_line,this._$.first_column+1),Instruccion.nuevoValor($3, TIPO_VALOR.ENTERO, this._$.first_line,this._$.first_column+1), TIPO_OPERACION.POTENCIA,this._$.first_line,this._$.first_column+1); }
        | operString OP_EXPONENTE ENTERO {$$= Instruccion.nuevaOperacionBinaria($1,Instruccion.nuevoValor($3, TIPO_VALOR.ENTERO, this._$.first_line,this._$.first_column+1), TIPO_OPERACION.POTENCIA,this._$.first_line,this._$.first_column+1); }
        | Expresiones TK_COMA Expresiones {$$= Instruccion.nuevaOperacionBinaria($1,$3, TIPO_OPERACION.SUMA,this._$.first_line,this._$.first_column+1); }
;
//--------------------------------------------------------------------------------------------------------------------------------------
...
Expresiones: CADENA {$$ = Instruccion.nuevoValor($1, TIPO_VALOR.CADENA, this._$.first_line,this._$.first_column+1)}
            ...
            | TK_TANGENTE PARENTESIS_ABRE Expresiones PARENTESIS_CIERRA { $$= Instruccion.nuevaOperacionBinaria(null,$3, TIPO_OPERACION.TANGETE,this._$.first_line,this._$.first_column+1);}
